			...
			<div class="container">
				<div class="row">
                    ...
                    <div class="col-md-12 col-md-offset-0 heading2 animate-box">
                                        ...
                                        <h2> <?php echo $this->vars[0]["location"] ?>  Πόλη:Βρέθηκαν  <?php echo count($this->vars)?> Αξιοθέατα</h2>
                                        <?php endif ?>
					...
					<div class="col-md-12">
						...
						<div class="side search-wrap animate-box">
							...
							<form method="GET" class="colorlib-form" action="/booking/landmarks">
				              	<div class="row">
				                <div class="col-md-12">
												...
												<div class="row" >
													...
													<div class="col-md-6 col-sm-6">
														...
														<div class="desc">
                                                             ...
                                                             <h2 style="margin:0px;"><a href="#" onclick="sendForm(<?php echo $this->vars[$i]["idlandmarks"]?>)" ><?php echo $this->vars[$i]["name"]?></a></h2>
                                                              <form class="colorlib-form" class="userinfo" action="/booking/showLandmark" method="get" style="display:none;">
				                ...
				                <div class="col-md-12">
				                  <div class="form-group">
				                    ...
				                    <div class="form-field">
				                      ...
				                      <input type="text" name="idlandmarks" class="form-control date" placeholder="Check-out date" value=<?php echo $this->vars[$i]["idlandmarks"]?> >
				                    </div>
				                  </div>
				                </div>
                                                                  </div>
	...
	<script src="/views/Booking/js/main.js"></script>
        ...
        <script>
            ...
            for(i=0; i<forms.length; i++){
                ...
                if(forms[i].elements["idlandmarks"].value==id){
