				...
				<div class="row">
				  ...
				  <div class="col-md-3">
							...
							<div class="side search-wrap animate-box">
								...
								<form method="get" class="colorlib-form" action="/booking/landmarkname">
				              	<div class="row">
				                <div class="col-md-12">
				                  <div class="form-group">
				                    <label for="date">Όνομα Αξιοθέατου:</label>
				                ...
				                <div class="col-md-12">
				                  <input type="submit" name="submit" id="submit" value="Βρείτε Αξιοθέατο" class="btn btn-primary btn-block">
				                </div>
				              </div>
				            </form>
							</div>
