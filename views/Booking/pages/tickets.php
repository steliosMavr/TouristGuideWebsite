	...
	<div class="colorlib-loader"></div>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(/views/Booking/images/flight.jpeg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>Ταξιδεψτε σε ολο τον κοσμο</h2>
				   					<h1 style="font-size:40px;">με μοναδικες τιμες</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
					...
					<div class="search-wrap">
						<div class="container">
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab" href="#aeroplane">Αεροπλάνο</a></li>
								<li><a data-toggle="tab" href="#ships">Πλοίο</a></li>
								
							</ul>
						</div>
						<div class="tab-content">
							<div id="aeroplane" class="tab-pane fade in active">
								
						      <form class="colorlib-form" action="/booking/ticketFinder" method="get">
				              	<div class="row">
				              	   <div class="col-md-3">
				                  <div class="form-group">
				                    <label for="date">Από</label>
				                    <div class="form-field">
				                     
				                      <input type="text" class="form-control " placeholder="Που θέλετε να πάτε" name="from" required>
				                    </div>
				                  </div>
				                </div>
                                     <div class="col-md-2">
				                  <div class="form-group">
				                    <label for="date">Πρός</label>
				                    <div class="form-field">
				                ...
				                <div class="col-sm-2">
				                  <div class="form-group">
				                    <label for="date">Αναχώρηση</label>
				                    <div class="form-field">
				                      <i class="icon icon-calendar2"></i>
				                      <input type="text" id="date" class="form-control date" placeholder="αναχώρηση" name="departure_date" required>
				                    </div>
				                  </div>
				                </div>
                                   
                                    
                                    <input id="" name="ticketType" type="hidden" value="aeroplane">
						     ...
						     <form class="colorlib-form" action="/booking/ticketFinder" method="get">
				                ...
				                <div class="col-sm-2">
				                  <div class="form-group">
                                    ...
                                    <input id="" name="ticketType" type="hidden" value="ships">
