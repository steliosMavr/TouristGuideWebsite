       ...
       <?php include $_SERVER["DOCUMENT_ROOT"].'/views/AdminPanel/header_sidebar/header_siderbar.php'?>
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h2 class="page-header">Εισαγωγή Δίκλινων Οχημάτων</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        ...
        <?php if(isset($_SESSION['msg'])){ echo $_SESSION['msg'];unset($_SESSION['msg']); }?>            
                ...
                <div class="col-lg-12">
                      <form role="form" action="/AdminPanel/sumbit/motoForm"  enctype="multipart/form-data" method="post">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                            <label>Κυβικά</label>
                                          <input class="form-control" name="kv" required>
                          ...
                          <div class="form-group">
                                        ...
                                        <input class="form-control" name="price_increase" required>
