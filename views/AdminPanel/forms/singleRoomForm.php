...
<body>
       ...
       <?php include $_SERVER["DOCUMENT_ROOT"].'/views/AdminPanel/header_sidebar/header_siderbar.php'?>
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h2 class="page-header">Εισαγωγή Μονόκλινων Δωματίων</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        ...
        <?php if(isset($_SESSION['msg'])){ echo $_SESSION['msg'];unset($_SESSION['msg']); }?>            
                ...
                <div class="col-lg-12">
                      <form role="form" action="/AdminPanel/sumbit/singleRoomForm"  enctype="multipart/form-data" method="post">
  ...
  <input class="form-check-input" type="radio" name="contain" id="exampleRadios2" value="1 Μονό Κρεβάτι">
  <label class="form-check-label" for="exampleRadios2">
    1 Μονό Κρεβάτι
  </label>
                              <input class="form-check-input" type="radio" name="contain" id="exampleRadios2" value="1 Μονό Καναπέ">
  <label class="form-check-label" for="exampleRadios2">
    1 Μονό Καναπέ
  </label>
</div>
